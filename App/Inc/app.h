...
/*駆動(小)のリミットスイッチは押されているか*/
#define _LIMITSW_DRIS_GPIOxID GPIOCID
#define _LIMITSW_DRIS_GPIOPIN GPIO_PIN_8
#define _IS_PRESSED_LIMITSW_DRIS() (!(MW_GPIORead(_LIMITSW_DRIS_GPIOxID, _LIMITSW_DRIS_GPIOPIN)))
